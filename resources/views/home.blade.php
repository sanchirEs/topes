...
@section('content')
                ...
                <div class="slide-item p_relative pt_120">
                    ...
                    <div class="auto-container">
                        <div class="content-box p_relative d_block z_5">
                            <h2 class="p_relative d_block fs_60 lh_70 fw_bold mb_9">Best <span>Electricty</span> Service for Your Family</h2>
                            ...
                            <div class="btn-box"><a href="about.html" class="theme-btn btn-one">About Company</a></div>
                        </div> 
                    </div>
                </div>
                <div class="slide-item p_relative pt_120">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-two wow fadeInUp" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <h3 class="p_relative d_block"><a href="index-2.html">Safety <br />Inspection</a></h3>
                                    <p>Lorem ipsum dolor amet adicing elit sed.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-two wow fadeInUp" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <h3 class="p_relative d_block"><a href="index-2.html">Electric <br />Installation</a></h3>
                                    <p>Lorem ipsum dolor amet adicing elit sed.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-two wow fadeInUp" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    ...
                                    <h3 class="p_relative d_block"><a href="index-2.html">Best <br />Maintanance</a></h3>
                                    <p>Lorem ipsum dolor amet adicing elit sed.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="service-block-one">
                        <div class="inner-box">
                            <div class="image-box p_relative d_block">
                                ...
                                <figure class="image p_relative d_block"><a href="air-conditioning.html"><img src="assets/images/service/service-3.jpg" alt=""></a></figure>
                            </div>
                            <div class="lower-content p_relative d_block">
                                ...
                                <div class="link"><a href="air-conditioning.html">Read more<i class="icon-7"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="service-block-one">
                        <div class="inner-box">
                            <div class="image-box p_relative d_block">
                                <div class="shape-1 p_absolute l_0 b_0"></div>
                                <div class="shape-2 p_absolute l_0 b_0"></div>
                                <figure class="image p_relative d_block"><a href="heating-service.html"><img src="assets/images/service/service-4.jpg" alt=""></a></figure>
                            </div>
                            <div class="lower-content p_relative d_block">
                                ...
                                <p>Lorem ipsum dolor amet consectur adicing elit sed.</p>
                                <div class="link"><a href="heating-service.html">Read more<i class="icon-7"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="service-block-one">
                        <div class="inner-box">
                            <div class="image-box p_relative d_block">
                                <div class="shape-1 p_absolute l_0 b_0"></div>
                                <div class="shape-2 p_absolute l_0 b_0"></div>
                                <figure class="image p_relative d_block"><a href="power-outlets.html"><img src="assets/images/service/service-5.jpg" alt=""></a></figure>
                            </div>
                            <div class="lower-content p_relative d_block">
                                <div class="icon-box p_absolute r_30 w_90 h_90 lh_90 fs_40 b_radius_50 centred"><i class="icon-17"></i></div>
                                <h3><a href="power-outlets.html">Eectrical Service</a></h3>
                                <p>Lorem ipsum dolor amet consectur adicing elit sed.</p>
                                <div class="link"><a href="power-outlets.html">Read more<i class="icon-7"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="service-block-one">
        ...
        <section class="faq-section p_relative">
            <div class="bg-layer" style="background-image: url(assets/images/resource/faq-3.jpg);"></div>
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                ...
                <div class="row align-items-center clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image-box mr_70">
                            ...
                            <figure class="image"><img src="assets/images/resource/vector-2.png" alt=""></figure>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
