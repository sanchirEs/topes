                            ...
                            <div class="widget-content">
                                <ul class="category-list clearfix">
                                    @foreach($categories as $category)
                                        <li><a href="{{ url('shopcategory/' . $category->id) }}"><i
                                                    class="icon-7"></i>{{$category->name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="item-shorting p_relative d_block clearfix">
                            <div class="left-column pull-left clearfix">
                                ...
                                <div class="text float_left">
                                    <p class="fs_16 font_family_poppins">Нийт <span class="color_black">
                                            {{ $products->total() }}</span>-с <span class="color_black">
                                            {{ $products->lastItem() }} </span>
